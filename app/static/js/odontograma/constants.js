...
// If Constants is intended to be a global constructor, ensure it's available.
// For ESLint, if it's used as `new Constants()` elsewhere, this file is fine.
// The 'no-unused-vars' might be if it's never instantiated with 'new'.
// Assuming it IS instantiated by the Engine or similar.
// One way to explicitly mark it as used for linters if it's a global constructor:
if (typeof window !== 'undefined') {
  window.OdontogramaConstants = Constants;
}
